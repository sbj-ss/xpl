...
static void* copyParamsCallback(void *payload, xmlChar *name)
{
...
static void freeParamsCallback(void* payload, xmlChar* name)
{
...
static void xplParamsToListScanner(void *payload, void *data, xmlChar *name)
{
